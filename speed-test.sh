...
#
# Usage:
#   ./speed-test.sh user@hostname outfile [test file size in kBs]
#
...
# print result
`rm $out_file`
echo "Upload $up_speed kB/s" >> $out_file
echo "Download $down_speed kB/s" >> $out_file
